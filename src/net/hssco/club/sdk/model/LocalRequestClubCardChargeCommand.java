...
/**
 * Request DTO for /api/android/psp/club/charge.
 */
public class LocalRequestClubCardChargeCommand {
    ...
    public LocalRequestClubCardChargeCommand() {
    }

    public LocalRequestClubCardChargeCommand(long requestId, int pspid, String merchantPin, String status,
                                             String messageType, String tranDate, String tranTime, long amount,
                                             String refrenceNumber, String terminalId, String stan, String pan,
                                             String creditValidation, String pin, String deviceTypeName,
                                             String secondPass, String cvv2, String description,
                                             String requestMessage, String cardNumber) {
